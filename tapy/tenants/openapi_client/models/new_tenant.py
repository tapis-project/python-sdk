...
class NewTenant(object):
    ...
    def __init__(self, tenant_id=None, base_url=None, is_owned_by_associate_site=None, token_service=None, security_kernel=None, authenticator=None, owner=None, service_ldap_connection_id=None, user_ldap_connection_id=None, description=None):  # noqa: E501
    ...
    def tenant_id(self, tenant_id):
        ...
        if tenant_id is not None and not re.search(r'^[a-zA-Z0-9-]*$', tenant_id):  # noqa: E501
            raise ValueError(r"Invalid value for `tenant_id`, must be a follow pattern or equal to `/^[a-zA-Z0-9-]*$/`")  # noqa: E501

        self._tenant_id = tenant_id

    @property
    def base_url(self):
        """Gets the base_url of this NewTenant.  # noqa: E501

        The base URL for the tenant.  # noqa: E501

        :return: The base_url of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def base_url(self, base_url):
        """Sets the base_url of this NewTenant.

        The base URL for the tenant.  # noqa: E501

        :param base_url: The base_url of this NewTenant.  # noqa: E501
        :type: str
        """
        if base_url is None:
    ...
    def is_owned_by_associate_site(self):
        """Gets the is_owned_by_associate_site of this NewTenant.  # noqa: E501

        Whether the tenant is hosted by an associate site.  # noqa: E501

        :return: The is_owned_by_associate_site of this NewTenant.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_owned_by_associate_site(self, is_owned_by_associate_site):
        """Sets the is_owned_by_associate_site of this NewTenant.

        Whether the tenant is hosted by an associate site.  # noqa: E501

        :param is_owned_by_associate_site: The is_owned_by_associate_site of this NewTenant.  # noqa: E501
        :type: bool
        """
    ...
    def token_service(self):
        """Gets the token_service of this NewTenant.  # noqa: E501

        The resolvable location of the token service for the tenant.  # noqa: E501

        :return: The token_service of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def token_service(self, token_service):
        """Sets the token_service of this NewTenant.

        The resolvable location of the token service for the tenant.  # noqa: E501

        :param token_service: The token_service of this NewTenant.  # noqa: E501
        :type: str
        """
    ...
    def security_kernel(self):
        """Gets the security_kernel of this NewTenant.  # noqa: E501

        The resolvable location of the security kernel for the tenant.  # noqa: E501

        :return: The security_kernel of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def security_kernel(self, security_kernel):
        """Sets the security_kernel of this NewTenant.

        The resolvable location of the security kernel for the tenant.  # noqa: E501

        :param security_kernel: The security_kernel of this NewTenant.  # noqa: E501
        :type: str
        """
    ...
    def authenticator(self):
        """Gets the authenticator of this NewTenant.  # noqa: E501

        The resolvable location of the authenticator for the tenant.  # noqa: E501

        :return: The authenticator of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def authenticator(self, authenticator):
        """Sets the authenticator of this NewTenant.

        The resolvable location of the authenticator for the tenant.  # noqa: E501

        :param authenticator: The authenticator of this NewTenant.  # noqa: E501
        :type: str
        """
    ...
    @property
    def owner(self):
        """Gets the owner of this NewTenant.  # noqa: E501

        The email address of the primary owner and contact for the tenant.  # noqa: E501

        :return: The owner of this NewTenant.  # noqa: E501
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """Sets the owner of this NewTenant.

        The email address of the primary owner and contact for the tenant.  # noqa: E501

        :param owner: The owner of this NewTenant.  # noqa: E501
        :type: str
        """
        if owner is None:
    ...
    def service_ldap_connection_id(self):
        """Gets the service_ldap_connection_id of this NewTenant.  # noqa: E501

        The unique identifier for the LDAP object for service accounts in the tenant.  # noqa: E501

        :return: The service_ldap_connection_id of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def service_ldap_connection_id(self, service_ldap_connection_id):
        """Sets the service_ldap_connection_id of this NewTenant.

        The unique identifier for the LDAP object for service accounts in the tenant.  # noqa: E501

        :param service_ldap_connection_id: The service_ldap_connection_id of this NewTenant.  # noqa: E501
        :type: str
        """
    ...
    def user_ldap_connection_id(self):
        """Gets the user_ldap_connection_id of this NewTenant.  # noqa: E501

        The unique identifier for the LDAP object for user accounts in the tenant.  # noqa: E501

        :return: The user_ldap_connection_id of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def user_ldap_connection_id(self, user_ldap_connection_id):
        """Sets the user_ldap_connection_id of this NewTenant.

        The unique identifier for the LDAP object for user accounts in the tenant.  # noqa: E501

        :param user_ldap_connection_id: The user_ldap_connection_id of this NewTenant.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this NewTenant.  # noqa: E501

        A description of the tenant.  # noqa: E501

        :return: The description of this NewTenant.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this NewTenant.

        A description of the tenant.  # noqa: E501

        :param description: The description of this NewTenant.  # noqa: E501
        :type: str
        """
